...
const Footer = () => {
  return (
    <>
      <div className="flex xl:flex-row flex-col gap-[30px] mt-[150px] justify-between px-[30px] xl:px-32">
        <div>
          <header className="self-center flex gap-[1%] items-start">
            <img
              loading="lazy"
          ...
          <p className="leading-[28px] text-[18px] text-[#475467] lg:w-[500px]">
            clearlink is your gateway to effortless, high quality video
            conferencing. Join us in shaping the future of communication!
          </p>
        </div>
        <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1  gap-[50px]">
          <ul className="flex flex-col gap-[14px]">
            <li className="text-[16px] text-[#667085] font-[inter] font-normal leading-[24px]">
              Product
            </li>
            <li className="text-[#475467] text-[18px] font-normal font-[600] leading-[28px]">
              Overview
            </li>
            <li className="text-[#475467] text-[18px] font-normal font-[600] leading-[28px]">
              Features
      ...
      <div className="md:flex justify-between py-[30px] mt-[50px] lg:px-48 px-[30px] pb-[30px] items-center bg-[#f9fafb]">
